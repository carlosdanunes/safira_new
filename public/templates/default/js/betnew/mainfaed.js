		...
		success: function(search){
			...
			var search_two = '';
				...
				for(const value of arr) {
					...
					theme_name = theme_name.replace('templates/index.html', '', theme_name);
					var img_game = "/templates/default/ico/"+name_game+".jpg"; //Ð·Ð°Ð¼ÐµÐ½Ð¸Ð» Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð³Ñ€ÑƒÐ·Ð¸Ð»Ð¸ÑÑŒ Ñ Ð¾Ð±Ñ‰ÐµÐ¹ Ð¿Ð°Ð¿ÐºÐ¸
...
function CF(){
	...
	if(email == "" || text == ""){
		$(".reply-contact-form").text("Ð—Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ð²ÑÐµ Ð¿Ð¾Ð»Ñ");
	}
	if(email != "" && text != ""){
		$.ajax({
			type: "POST",
			...
			success: function(){
				$(".reply-contact-form").text("Ð¡Ð¾Ð¾Ð±Ñ‰ÐµÐ½Ð¸Ðµ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¾");
				setTimeout(function(){
