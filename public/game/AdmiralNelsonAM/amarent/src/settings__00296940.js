...
function Settings()
{
	...
	this.value72 = {EUR:{s:"\u20AC",m:0.01,ts:null,cs:"."},GBP:{s:"\u00A3",m:0.01,ts:null,cs:"."},USD:{s:"\u0024",m:0.01,ts:null,cs:"."},AUD:{s:"\u0024",m:0.01,ts:null,cs:"."},CAD:{s:"\u0024",m:0.01,ts:null,cs:"."},NZD:{s:"\u0024",m:0.01,ts:null,cs:"."},NOK:{s:"kr",m:0.01,ts:null,cs:"."},SEK:{s:"kr",m:0.01,ts:null,cs:"."},ZAR:{s:"R",m:0.01,ts:null,cs:"."},INR:{s:"\u20B9",m:1,ts:null,cs:null},RUB:{s:"\u20BD",m:0.01,ts:null,cs:"."},CHF:{s:"CHF",m:0.01,ts:null,cs:"."},HRK:{s:"kn",m:0.01,ts:null,cs:"."},HUF:{s:"Ft",m:1,ts:null,cs:null},GEL:{s:"\u20BE",m:0.01,ts:null,cs:"."},UAH:{s:"\u20B4",m:0.01,ts:null,cs:"."},RON:{s:"lei",m:0.01,ts:null,cs:"."},BRL:{s:"R\u0024",m:0.01,ts:null,cs:"."}};
	this.value30 = "..";
	this.value40 = 1.0;
