					...
					<div class="tab-pane" id="affiliates" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<input type="text" class="form-control" placeholder="30" value="<?php echo e($settings->ref_perc); ?>" name="ref_perc">
							</div>
							<div class="col-lg-4">
								<label>Qual o valor que o convidado no primeiro depósito:</label>
								<input type="text" class="form-control" placeholder="20" value="<?php echo e($settings->ref_sum); ?>" name="ref_sum">
							</div>
							<div class="col-lg-4">
								<label>Valor mínimo de retirada de da conta de afiliado:</label>
								<input type="text" class="form-control" placeholder="100" value="<?php echo e($settings->min_ref_withdraw); ?>" name="min_ref_withdraw">
							</div>
						</div>
					</div>
