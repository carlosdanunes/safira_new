                                        ...
                                        <form action="/pay" method="post" id="payment">
                                                ...
                                                <label>
                                                    ...
                                                    <div class="form-field">
                                                        <div class="input-valid">
                                                            ...
                                                            <small class="text-warning">Obs: Valor mínimo de depósito R$ 20,00.</small>
                                            ...
                                            <div class="form-row" {{$u->cpf == NULL ? '' : 'hidden'}}>
											 ...
											 <div class="checkbox-block">
                                                <label>Aceito receber os 100% de bônus.
                                                    <input name="deposit-bonus" type="checkbox" id="deposit-bonus"><span
