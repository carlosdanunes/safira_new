                     ...
                     <div class="eng-superior-menu">
                        <div class="left-side-bar_navigation-wrapper">
                           <div class="eng-sublinks-nav">
                              ...
                              <?php if ($this->session->is_afiliado == 1): ?> 
                              <a href="<?= base_url(); ?>usuarios/afiliado" class="sublink-nav w-inline-block">
                                 <div class="content-sublink-menu">
                                    <div class="icon-20 fixed-width"></div>
                                    <div>Afiliado</div>
                                 </div>
                           ...
                           <div class="line-divisor-nav"></div>
                           <div class="eng-sublinks-nav">
                              <a open-support-btn="" href="#" class="sublink-nav w-inline-block" onclick="javascript:void(jivo_api.open());">
                                 <div class="content-sublink-menu">
                                    <div class="icon-20 fixed-width"></div>
                                    <div>Suporte</div>
                                 </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="card windows">
      ...
      <div class="form w-form">
         <form method="post" action="<?= base_url(); ?>payment/saque" id="sacar" name="sacar">
            <div class="gray-3">Quantia (Mínimo de <span tenant-min-withdraw=""><?=$config[0]->minsaque ?></span> BRL)</div>
      ...
      <button type="submit" class="mt-16 btn-small btn-color-1 w-inline-block" form="sacar">
         <div class="content-btn">
            <div>Sacar</div>
         </div>
      </button>
  ...
  <div class="modal-dialog">
   ...
   <div class="align-center-windows">
         <div class="card windows">
            ...
            <div class="form w-form">
               <form id="enviarPagamento" method="post" action="<?= base_url(); ?>payment/deposit">
                  <div class="gray">Valor do depósito (Depósito mínimo de <span tenant-min-deposit="">R$10 </span>BRL)</div>
            ...
            <div class="eng-qr-code">
               <div class="img-qr-code">
                  ...
                  <div class="eng-text-field mb-1">
                     ...
                     <a onclick="copyTextToClipboard('#qrCodeTexto')" href="#" class="btn-small btn-color-1 w-button"><span class="icon-16"></span> Copiar código</a>
                  </div>
                  </div>
               </div>
            </div>
